    ...
    [
        {
            ...
            "children": [
                {"path": "analysis", "component": "views/Dashboard/Analysis", "name": "Analysis", "status": 1, "id": 2, "meta": {"title": "分析页", "noCache": True}},
                {"path": "workplace", "component": "views/Dashboard/Workplace", "name": "Workplace", "status": 1, "id": 3, "meta": {"title": "工作台", "noCache": True}}
            ]
        },
        {
            "path": "/external-link",
            ...
            "id": 4,
            "children": [
                {"path": "https://element-plus-admin-doc.cn/", "name": "DocumentLink", "status": 1, "id": 5, "meta": {"title": "文档"}}
            ]
        },
        {
            "path": "/level",
            ...
            "status": 1,
            "id": 6,
            "meta": {"title": "菜单", "icon": "vi-carbon:skill-level-advanced"},
            "children": [
                {
                    "path": "menu1", "name": "Menu1", "component": "##", "status": 1, "id": 7, "redirect": "/level/menu1/menu1-1/menu1-1-1", "meta": {"title": "菜单1"},
                    "children": [
                        {
                            "path": "menu1-1", "name": "Menu11", "component": "##", "status": 1, "id": 8, "redirect": "/level/menu1/menu1-1/menu1-1-1", "meta": {"title": "菜单1-1", "alwaysShow": True},
                            "children": [
                                {"path": "menu1-1-1", "name": "Menu111", "component": "views/Level/Menu111", "status": 1, "id": 9, "permission": ["edit", "add", "delete"], "meta": {"title": "菜单1-1-1", "permission": ["edit", "add", "delete"]}}
                            ]
                        },
                        {"path": "menu1-2", "name": "Menu12", "component": "views/Level/Menu12", "status": 1, "id": 10, "permission": ["edit", "add", "delete"], "meta": {"title": "菜单1-2", "permission": ["edit", "add", "delete"]}}
                    ]
                },
                {"path": "menu2", "name": "Menu2Demo", "component": "views/Level/Menu2", "status": 1, "id": 11, "permission": ["edit", "add", "delete"], "meta": {"title": "菜单2", "permission": ["edit", "add", "delete"]}}
            ]
        },
        {
            "path": "/example",
            ...
            "status": 1,
            "id": 12,
            "meta": {"title": "综合示例", "icon": "vi-ep:management", "alwaysShow": True},
            "children": [
                {"path": "example-dialog", "component": "views/Example/Dialog/ExampleDialog", "name": "ExampleDialog", "status": 1, "id": 13, "permission": ["edit", "add", "delete"], "meta": {"title": "综合示例-弹窗", "permission": ["edit", "add", "delete"]}},
                {"path": "example-page", "component": "views/Example/Page/ExamplePage", "name": "ExamplePage", "status": 1, "id": 14, "permission": ["edit", "add", "delete"], "meta": {"title": "综合示例-页面", "permission": ["edit", "add", "delete"]}},
                {"path": "example-add", "component": "views/Example/Page/ExampleAdd", "name": "ExampleAdd", "status": 1, "id": 15, "permission": ["edit", "add", "delete"], "meta": {"title": "综合示例-新增", "noTagsView": True, "noCache": True, "hidden": True, "showMainRoute": True, "activeMenu": "/example/example-page", "permission": ["edit", "add", "delete"]}},
                {"path": "example-edit", "component": "views/Example/Page/ExampleEdit", "name": "ExampleEdit", "status": 1, "id": 16, "permission": ["edit", "add", "delete"], "meta": {"title": "综合示例-编辑", "noTagsView": True, "noCache": True, "hidden": True, "showMainRoute": True, "activeMenu": "/example/example-page", "permission": ["edit", "add", "delete"]}},
                {"path": "example-detail", "component": "views/Example/Page/ExampleDetail", "name": "ExampleDetail", "status": 1, "id": 17, "permission": ["edit", "add", "delete"], "meta": {"title": "综合示例-详情", "noTagsView": True, "noCache": True, "hidden": True, "showMainRoute": True, "activeMenu": "/example/example-page", "permission": ["edit", "add", "delete"]}}
            ]
        }
    ],
    # 管理员
